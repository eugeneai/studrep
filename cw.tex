...
о преддипломной практике на тему: % <<Разработка WEB-приложений>>

\textbf{Название ВКР работы}
...
\bibitem{b13}  Рубрикатор по нанонауке и нанотехнологиям. -- URL:\url{http/www.rubric.neicon.ru} (дата обращения: 12-02-2022)
\end{thebibliography}
